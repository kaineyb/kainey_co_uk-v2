...
When updating the state in React I was taught to first copy the objects using the spread operator. However, this doesn't actually copy the objects, it just copies the reference of the object. ie, it's the same object!
